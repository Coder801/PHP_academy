...
//Объявления функций сортировки по параметру
	...
	function sorting_height ($a, $b) {
		if ($a['parametres']['height'] == $b['parametres']['height']) return $a['number'] > $b['number'] ? 1 : -1;
